...
//#warning "Unimplemented function: uint8_t button_getButton(void)"	// delete warning after implementing
    ...
    // TODO: Write code below -- Return the left-most button position pressed

    uint8_t buttonPressed = 0;

    //testing if button 4 has been pressed
    if ((GPIO_PORTE_DATA_R | ~(0b00001000)) == ~(0b00001000))
    {
        buttonPressed = 4;
    }

    //testing if button 3 has been pressed
    else if ((GPIO_PORTE_DATA_R | ~(0b00000100)) == ~(0b00000100))
    {
        buttonPressed = 3;
    }

    //testing if button 2 has been pressed
    else if ((GPIO_PORTE_DATA_R | ~(0b00000010)) == ~(0b00000010))
    {
        buttonPressed = 2;
    }

    //testing if button 1 has been pressed
    else if ((GPIO_PORTE_DATA_R | ~(0b00000001)) == ~(0b00000001))
    {
        buttonPressed = 1;
    }

    //testing if button 0 has been pressed
    else
    {
        buttonPressed = 0;
    }
